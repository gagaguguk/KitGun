...
#[derive(Debug)]
pub struct KitGunDBProcessor {
    verbose: bool,
    processed_count: usize,
}

impl KitGunDBProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting KitGunDB processing");
    
    let mut processor = KitGunDBProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = KitGunDBProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = KitGunDBProcessor::new(false);
